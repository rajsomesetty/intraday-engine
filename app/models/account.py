...
class Account(Base):
    ...
    # Equity tracking
    intraday_peak_equity = Column(Numeric, nullable=True)
    current_equity = Column(Numeric, nullable=True)

    # Risk controls
    max_intraday_drawdown = Column(Numeric, nullable=False, default=50000)
